  ...
  return(
    <>
        ...
        <div className="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-[#f8f4f3]">
            ...
            <div className="mb-4 mt-8 flex items-center justify-center gap-x-6">
                    {/* <a
                        href={`${id}/edit`}
            ...
            <img className="rounded-full w-96 h-96 p-8" src={postData.imageurl} alt="image description"></img>
