export default function Edit() {
    ...
    return(
      <div className="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-[#f8f4f3]">
        ...
        <h1>Edit</h1>
            <img className="h-auto max-w-lg rounded-lg" src="https://www.freecodecamp.org/news/content/images/size/w2000/2022/04/pexels-markus-winkler-4052195.jpg" alt="image description"></img>
    <form className="mt-8">
        <div>
        ...
        <div>
            <label for="image" class="block mb-2 mt-3 text-sm font-medium text-gray-900 dark:text-white">Image/Url</label>
            <input type="text" id="image" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"/>
        </div>
